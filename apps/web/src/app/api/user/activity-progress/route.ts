    ...
    Object.keys(activityCompletion).forEach(activityIdStr => {
      ...
      switch (activityId) {
        ...
        case 6:
          ...
          break;
        case 11:
          // Aventura 1 (Nivel Avanzado) is completed when juego4 (final step) is completed
          isActivityCompleted = activity.scenes['juego4']?.status === 'completed' &&
                               activity.scenes['juego4']?.progress >= 100;
          break;
        case 12:
        ...
        case 13:
          ...
          break;
        case 14:
          // Aventura 4 (Nivel Avanzado) is completed when scene3 (final step) is completed
          isActivityCompleted = activity.scenes['scene3']?.status === 'completed' &&
                               activity.scenes['scene3']?.progress >= 100;
          break;
        case 15:
          // Aventura 5 (Nivel Avanzado) is completed when scene2 (final step) is completed
          isActivityCompleted = activity.scenes['scene2']?.status === 'completed' &&
                               activity.scenes['scene2']?.progress >= 100;
          break;
        case 16:
          // Aventura 6 (Nivel Avanzado) is completed when scene4 (final step) is completed
          isActivityCompleted = activity.scenes['scene4']?.status === 'completed' &&
                               activity.scenes['scene4']?.progress >= 100;
          break;
        case 17:
          // Aventura 7 (Nivel Avanzado) is completed when scene4 (final step) is completed
          isActivityCompleted = activity.scenes['scene4']?.status === 'completed' &&
                               activity.scenes['scene4']?.progress >= 100;
          break;
        case 18:
          // Aventura 8 (Nivel Avanzado) is completed when scene6 (final step) is completed
          isActivityCompleted = activity.scenes['scene6']?.status === 'completed' &&
                               activity.scenes['scene6']?.progress >= 100;
          break;
        default:
