...
function UserCreatedPageContent() {
  ...
  useEffect(() => {
    ...
    if (credentialsParam) {
      ...
      // If no credentials, redirect back to users list
      router.push('/dashboard/owner/users');
    }
  }, [searchParams, router]);
      ...
      <div className="p-6">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              onClick={() => router.push(`/dashboard/owner/users/${credentials.id}`)}
