    ...
    <AnimatePresence>
      {isVisible && (
        <>
          ...
          >
            <div className="bg-gradient-to-br from-purple-200 via-indigo-100 to-blue-300 rounded-xl shadow-2xl w-[80vw] h-[80vh] overflow-y-auto relative border-4 border-purple-300">
              ...
              <div className="relative z-10 flex flex-col items-center justify-center h-full text-center p-8">
                ...
                <h2 className="text-3xl font-bold text-purple-800 mb-4">
                  Juego Tres - Actividad 5
                </h2>
                
                <p className="text-lg text-purple-700 mb-8 max-w-md">
                  Este será el tercer y último juego de la Actividad 5. 
                  La gran culminación de esta experiencia educativa.
                </p>
