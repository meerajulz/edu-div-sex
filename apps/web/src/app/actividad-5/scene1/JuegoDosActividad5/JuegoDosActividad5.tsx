    ...
    <AnimatePresence>
      {isVisible && (
        <>
          ...
          >
            <div className="bg-gradient-to-br from-green-200 via-teal-100 to-blue-300 rounded-xl shadow-2xl w-[80vw] h-[80vh] overflow-y-auto relative border-4 border-teal-300">
              ...
              <div className="relative z-10 flex flex-col items-center justify-center h-full text-center p-8">
                ...
                <h2 className="text-3xl font-bold text-teal-800 mb-4">
                  Juego Dos - Actividad 5
                </h2>
                
                <p className="text-lg text-teal-700 mb-8 max-w-md">
                  Este será el segundo juego de la Actividad 5. 
                  Una experiencia educativa única está en camino.
                </p>

                <div className="bg-white/50 rounded-lg p-6 mb-8">
                  <div className="text-teal-600 font-semibold mb-2">Estado: En desarrollo</div>
                  <div className="w-full bg-teal-200 rounded-full h-3">
                    <div className="bg-teal-500 h-3 rounded-full w-0 animate-pulse"></div>
                  </div>
                </div>
