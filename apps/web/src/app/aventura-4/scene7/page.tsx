...
export default function Aventura4Scene7Page() {
  useActivityTracking();
  ...
  const handleGoHome = async () => {
    ...
    await saveProgress('aventura-4', 'scene7', 'completed', 100, {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-yellow-300 via-orange-300 to-pink-400" />
      ...
      {!showFelicidades ? (
        <div className="relative z-20 flex flex-col items-center justify-center min-h-screen gap-8">
          ...
          >
            ...
            <p className="text-white text-lg">¿Cómo decir que no?</p>
          </motion.div>

          <motion.button
            onClick={() => setShowFelicidades(true)}
            className="bg-white text-orange-600 font-bold py-3 px-8 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
        ...
        >
          ...
          >
            ...
            <p className="text-white text-lg mb-6">
              Has completado la Aventura Nos entendemos y respetamos
            </p>
            <motion.button
