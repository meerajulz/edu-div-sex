...
export const AVENTURA_2_CONFIG: ActivityConfig = {
  ...
  sections: [
    ...
    },
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-hover.svg',
      soundClick: '/audio/advance-actividad2/label/mAct5.mp3',
      xPosition: -180,
      yPosition: 250,
      zPosition: -850,
      scale: 1.3,
  ...
  sections: [
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-hover.svg',
      soundClick: '/audio/advanced-aventura1/label/mAct1/m1.mp3',
      xPosition: -60,
      yPosition: 280,
      zPosition: 150,
      scale: 0.9,
    ...
    },
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-2-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-2-hover.svg',
      soundClick: '/audio/advanced-aventura1/label/mAct1/m2.mp3',
      xPosition: 100,
      yPosition: 350,
      zPosition: -50,
      scale: 1,
    ...
    },
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-3-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-3-hover.svg',
      soundClick: '/audio/advanced-aventura1/label/mAct1/m3.mp3',
      xPosition: -150,
      yPosition: 280,
      zPosition: -300,
      scale: 1.2,
    ...
    },
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-4-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-4-hover.svg',
      soundClick: '/audio/advanced-aventura1/label/mAct1/m4.mp3',
      xPosition: 100,
      yPosition: 250,
      zPosition: -300,
      scale: 1.2,
...
export const AVENTURA_4_CONFIG: ActivityConfig = {
  ...
  sections: [
    {
      id: 1,
      title: 'LA CARA HABLA MÁS QUE LAS PALABRAS',
      scenes: ['/aventura-4/scene1'],
      isUnlocked: true,
      isCompleted: false,
      activeImage: '/svg/menu-actividad/cartell-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-hover.svg',
      soundClick: '/audio/actividad-4/label/mA1.mp3',
      xPosition: -60,
      yPosition: 280,
      zPosition: 150,
      scale: 0.9,
    ...
    },
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-2-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-2-hover.svg',
      soundClick: '/audio/actividad-4/label/mA2.mp3',
      xPosition: 100,
      yPosition: 380,
      zPosition: -200,
      scale: 1.1,
    ...
    },
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-3-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-3-hover.svg',
      soundClick: '/audio/actividad-4/label/mA3.mp3',
      xPosition: -120,
      yPosition: 300,
      zPosition: -600,
      scale: 1.3,
...
// Aventura 6 – Nivel Avanzado
export const AVENTURA_6_CONFIG: ActivityConfig = {
  activityId: 16,
  activitySlug: 'aventura-6',
  title: 'Relaciones de pareja',
  sections: [
    {
      id: 1,
      title: 'LA RELACIÓN DE PAREJA',
      scenes: ['/aventura-6/scene1'],
      isUnlocked: true,
      isCompleted: false,
      activeImage: '/svg/menu-actividad/cartell-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-hover.svg',
      soundClick: '/audio/advance--aventura-6/labels/a1.mp3',
      xPosition: -60,
      yPosition: 280,
      zPosition: 150,
      scale: 0.9,
    ...
    },
    {
      id: 2,
      title: 'LOS CELOS',
      scenes: ['/aventura-6/scene1-1'],
      isUnlocked: false,
      isCompleted: false,
      activeImage: '/svg/menu-actividad/cartell-2-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-2-hover.svg',
      soundClick: '/audio/advance--aventura-6/labels/a2.mp3',
      xPosition: 100,
      yPosition: 380,
      zPosition: -50,
      scale: 1.0,
    ...
    {
      id: 3,
      title: '¿PUEDO TENER DOS PAREJAS?',
      scenes: ['/aventura-6/scene2'],
      isUnlocked: false,
      isCompleted: false,
      activeImage: '/svg/menu-actividad/cartell-3-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-3-hover.svg',
      soundClick: '/audio/advance--aventura-6/labels/a3.mp3',
      xPosition: -150,
      yPosition: 280,
      zPosition: -300,
      scale: 1.1,
    ...
    {
      id: 4,
      title: '¿CÓMO CORTAR CON TU PAREJA?',
      scenes: ['/aventura-6/scene3'],
      isUnlocked: false,
      isCompleted: false,
      activeImage: '/svg/menu-actividad/cartell-4-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-4-hover.svg',
      soundClick: '/audio/advance--aventura-6/labels/a4.mp3',
      xPosition: 80,
      yPosition: 350,
      zPosition: -500,
      scale: 1.2,
    ...
    {
      id: 5,
      title: '¿QUÉ HACEMOS CUANDO NOS DEJAN?',
      scenes: ['/aventura-6/scene4'],
      isUnlocked: false,
      isCompleted: false,
      activeImage: '/svg/menu-actividad/cartell-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-hover.svg',
      soundClick: '/audio/advance--aventura-6/labels/a5.mp3',
      xPosition: -50,
      yPosition: 250,
      zPosition: -700,
      scale: 1.3,
...
// Aventura 7 – Nivel Avanzado
export const AVENTURA_7_CONFIG: ActivityConfig = {
  activityId: 17,
  activitySlug: 'aventura-7',
  title: 'Prácticas sexuales, asertividad y pornografía',
  sections: [
    {
      id: 1,
      title: 'DIFERENTES GUSTOS, DIFERENTES PRÁCTICAS SEXUALES',
      scenes: ['/aventura-7/scene1'],
      isUnlocked: true,
      isCompleted: false,
      activeImage: '/svg/menu-actividad/cartell-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-hover.svg',
      soundClick: '/audio/advance-aventura7/labels/a1.mp3',
      xPosition: -60,
      yPosition: 280,
      zPosition: 150,
      scale: 0.9,
    ...
    {
      id: 2,
      title: 'EL PRESERVATIVO NOS PROTEGE',
      scenes: ['/aventura-7/scene2'],
      isUnlocked: false,
      isCompleted: false,
      activeImage: '/svg/menu-actividad/cartell-2-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-2-hover.svg',
      soundClick: '/audio/advance-aventura7/labels/a2.mp3',
      xPosition: 100,
      yPosition: 380,
      zPosition: -50,
      scale: 1.0,
    ...
    {
      id: 3,
      title: '¿QUÉ HACEMOS CON EL PRESERVATIVO USADO?',
      scenes: ['/aventura-7/scene3'],
      isUnlocked: false,
      isCompleted: false,
      activeImage: '/svg/menu-actividad/cartell-3-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-3-hover.svg',
      soundClick: '/audio/advance-aventura7/labels/a3.mp3',
      xPosition: -150,
      yPosition: 280,
      zPosition: -300,
      scale: 1.1,
    ...
    {
      id: 4,
      title: 'LAS PELÍCULAS NO SIEMPRE MUESTRAN LA REALIDAD',
      scenes: ['/aventura-7/scene4'],
      isUnlocked: false,
      isCompleted: false,
      activeImage: '/svg/menu-actividad/cartell-4-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-4-hover.svg',
      soundClick: '/audio/advance-aventura7/labels/a4.mp3',
      xPosition: 80,
      yPosition: 350,
      zPosition: -500,
      scale: 1.2,
  ...
  sections: [
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-hover.svg',
      soundClick: '/audio/labels/avanzado/mAct8/m1.mp3',
      xPosition: -60,
      yPosition: 280,
      zPosition: 150,
      scale: 0.9,
    ...
    },
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-2-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-2-hover.svg',
      soundClick: '/audio/labels/avanzado/mAct8/m2.mp3',
      xPosition: 100,
      yPosition: 380,
      zPosition: -50,
      scale: 1.0,
    ...
    },
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-3-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-3-hover.svg',
      soundClick: '/audio/labels/avanzado/mAct8/m3.mp3',
      xPosition: -150,
      yPosition: 280,
      zPosition: -300,
      scale: 1.1,
    ...
    },
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-4-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-4-hover.svg',
      soundClick: '/audio/labels/avanzado/mAct8/m4.mp3',
      xPosition: 80,
      yPosition: 350,
      zPosition: -500,
      scale: 1.2,
    ...
    },
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-hover.svg',
      soundClick: '/audio/labels/avanzado/mAct8/m5.mp3',
      xPosition: -50,
      yPosition: 250,
      zPosition: -700,
      scale: 1.3,
    ...
    },
    {
      ...
      activeImage: '/svg/menu-actividad/cartell-active.svg',
      inactiveImage: '/svg/menu-actividad/cartell-hover.svg',
      soundClick: '/audio/labels/avanzado/mAct8/m6.mp3',
      xPosition: 60,
      yPosition: 300,
      zPosition: -900,
      scale: 1.4,
