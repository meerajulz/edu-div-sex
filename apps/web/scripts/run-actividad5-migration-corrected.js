...
async function runMigration() {
  ...
  try {
    console.log('🚀 Starting actividad-5 database migration (corrected)...');

    // Read the corrected SQL file
    const sqlPath = path.join(__dirname, 'add-actividad5-scenes-corrected.sql');
    ...
    // Verify the data was updated/inserted
    ...
    console.log('🔍 Verification - Updated Actividad-5 scenes:');
